...
public class UserService09Impl implements IUserService09 {
	...
	@Autowired
	private WordcloudRedisDao WordcloudRedisDao;
	 ...
	 * 根据title来获取redis的key
	 */
	public String getWordcloudRedisKey() {
		return ChartTypeConstant.WORDCLOUD_REDIS;
	}

	public String getWordcloudChartOption(){

		String type = getWordcloudRedisKey();

		String WordcloudData = WordcloudRedisDao.getWordcloudData(type);
		...
		//插入缓存中
		WordcloudRedisDao.setWordcloudData(type, option.toString());
